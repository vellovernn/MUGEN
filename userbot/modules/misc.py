...
async def killdabot(event):
    ...
    await event.edit("`Mematikan GabutC-UBot....`")
    await asyncio.sleep(7)
    await event.delete()
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#SHUTDOWN \n"
                                        "`GabutC-UBot Telah Dimatikan`")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[GabutC-UBot Repo](https://github.com/Ependelope53/GabutC-UBot/blob/Lord-Userbot/README.md)"
